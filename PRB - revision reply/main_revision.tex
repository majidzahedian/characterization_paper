...
The blind spot term, B, shows that how this sequence can be engineered to increase or reduce the signal amplitude of one nuclear spin from the spectrum. \st{The bright and blind spots of a frequency in the spectrum are as follows} \textcolor{black}{The Eq. \ref{eq:BS} suggests the bright and blind spots of a frequency can be obtained as follows}:
\begin{align}
...
\bibitem [{\citenamefont {Hesselmeier}\ \emph {et~al.}(2024)\citenamefont
  ...
  }\href@noop {} {\bibfield  {journal} {\bibinfo  {journal} {Physical Review Letters}\ } (\bibinfo {year} {2024})}\BibitemShut {NoStop}%
%9
