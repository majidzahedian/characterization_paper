...
\title{Blueprint for nuclear spin characterization in  color center}% Force line breaks with \\
...
\begin{figure*}[htbp]
	\begin{center}
		\includegraphics[width=0.8\textwidth]{pict/dd_compare.pdf}
...
\begin{figure*}[htbp]
	\begin{center}
		\includegraphics[width=0.8\textwidth]{pict/Fisher.pdf}
		\caption{a. DD spin 1 b. DD spin 1/2 c. 5pESEEM spin 1 d. 5pESEEM spin 1/2 }
		\label{fig:Fisher}
	\end{center}
\end{figure*}
...
\begin{figure*}[htbp]
	\begin{center}
		\includegraphics[width=0.9\textwidth]{pict/eseem_compare.pdf}
